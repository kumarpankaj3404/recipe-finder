    ...
    return (
        <div className="min-h-screen flex justify-center items-center relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 bg-neutral-950">
                <div className="absolute top-[20%] right-[20%] w-[40%] h-[40%] bg-orange-500/10 rounded-full blur-[100px]"></div>
                <div className="absolute bottom-[20%] left-[20%] w-[40%] h-[40%] bg-amber-500/10 rounded-full blur-[100px]"></div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-3xl shadow-2xl w-full max-w-md mx-4">
                ...
                <p className="mt-8 text-center text-gray-400">
                    ...
                    <Link to="/login" className="text-orange-400 font-bold hover:text-orange-300 hover:underline transition">
                        Sign In
                    </Link>
                </p>
            </div>
